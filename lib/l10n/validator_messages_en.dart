...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(fieldName, value) => "${fieldName} must have a maximum value of ${value}.";

  static m15(fieldName, value) => "${fieldName} must have a minimum value of ${value}.";

  static m16(fieldName) => "${fieldName} must not be included in the given list of values.";
  ...
  static m20(fieldName, field) => "${fieldName} must have the same value as ${field}.";
