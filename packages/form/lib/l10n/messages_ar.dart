...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m26(fieldName) => "${fieldName} يجب أن يكون رقم هاتف صالح.";

  static m27(fieldName, min, max) => "يجب عليك تحديد بين ${min} و ${max} خيارات لـ ${fieldName}.";

  static m28(fieldName) => "${fieldName} يجب أن يطابق النمط المحدد.";

  static m29(fieldName) => "${fieldName} مطلوب.";

  static m30(fieldName, field) => "${fieldName} يجب أن يكون له نفس القيمة كـ ${field}.";

  static m31(fieldName, value) => "${fieldName} يجب أن يكون حجمه ${value}.";

  static m32(fieldName) => "${fieldName} يجب أن يكون عنوان URL صالح.";
